    ...
    <>
      <div>
        <div className="w-full min-h-screen p-10 landing-grid-bg flex flex-col gap-4">
          ...
          <p className="text-5xl tracking-tight text-black">Designs</p>
          ...
          <div className="flex flex-col w-full gap-4 bg-white rounded-2xl p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {designs.map((design) => (
                <div key={design.id} className="bg-black/10 p-4 rounded-lg">
                  <p className="text-lg font-bold text-white">{design.title}</p>
                </div>
              ))}
            </div>
            <p className="text-sm text-black/50 text-center py-4">More Designs coming soon...</p>
          </div>
